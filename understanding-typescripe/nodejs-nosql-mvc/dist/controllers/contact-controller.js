...
async function contactHome(req, res) {
    ...
    try {
        ...
        const contacts = await contact_model_1.Contact.getAll();
        res.render("contacts", {
            contacts,
...
async function addContactController(req, res) {
    ...
    const contact = new contact_model_1.Contact(req.body.name, req.body.phone, req.body.category, req.file?.path || "");
    await contact.save();
...
async function editContactPage(req, res) {
    ...
    try {
        const categories = await category_model_1.Category.getAll();
        const contact = new contact_model_1.Contact("", "", "", "", req.params.id);
...
async function updateContactController(req, res) {
    ...
    try {
        ...
        const contact = new contact_model_1.Contact(req.body.name, req.body.phone, req.body.category, avatar ? avatar.path : "", req.body.id);
...
async function deleteContactController(req, res) {
    ...
    try {
        const contact = new contact_model_1.Contact("", "", "", "", req.body.id);
