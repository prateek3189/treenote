        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    category = new category_model_1.Category(req.body.name);
...
function editCategoryPage(req, res) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    category = new category_model_1.Category("", req.params.id);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    category = new category_model_1.Category(req.body.name, req.body.id);
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    category = new category_model_1.Category("", req.body.id);
                    return [4 /*yield*/, category.delete()];
                case 2:
                    _a.sent();
                    req.session.additionalInfo = {
